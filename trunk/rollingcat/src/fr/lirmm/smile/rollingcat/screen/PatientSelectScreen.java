...
public class PatientSelectScreen implements Screen{
	...
	public void show() {
		...
		if(patients.size() > 0){
			...
			tableRightBottom.setBackground(skin.getDrawable("bottom_green"));
			tableRightTop.setBackground(skin.getDrawable("top_orange"));
			...
			tableRightTop.add(workspaceHeight).right().padLeft(GameConstants.BLOCK_WIDTH * 2).height(GameConstants.BLOCK_HEIGHT);
			tableRightTop.row();
			tableRightTop.add(widthLabel).left().pad(GameConstants.BLOCK_WIDTH * 0.2f);
			tableRightTop.add(workspaceWidth).right().height(GameConstants.BLOCK_HEIGHT);
			tableRightTop.row();
			tableRightTop.add(nbSuccessLabel).left().pad(GameConstants.BLOCK_WIDTH * 0.2f);
			tableRightTop.add(nbSuccess).right().height(GameConstants.BLOCK_HEIGHT);
			tableRightTop.row();
			tableRightTop.add(totalVolumeLabel).left().pad(GameConstants.BLOCK_WIDTH * 0.2f);
			tableRightTop.add(totalVolume).right().height(GameConstants.BLOCK_HEIGHT);
			tableRightTop.row();
			tableRightTop.add(timeoutLabel).left().pad(GameConstants.BLOCK_WIDTH * 0.2f);
			tableRightTop.add(timeout).right().height(GameConstants.BLOCK_HEIGHT);;
			tableRightTop.row();
			
			tableRightTop.add(reversedLevelLabel).left().pad(GameConstants.BLOCK_WIDTH * 0.2f);
			tableRightTop.add(reversedLevel).right().padRight(GameConstants.BLOCK_WIDTH * 1.5f).height(GameConstants.BLOCK_HEIGHT);;
			tableRightTop.row();
			
			tableRightTop.add(rangeLabel).left().pad(GameConstants.BLOCK_WIDTH * 0.2f);
			tableRightTop.add(range).right().height(GameConstants.BLOCK_HEIGHT);
			tableRightTop.row();
			tableRightTop.add(evaporationPerDayLabel).left().pad(GameConstants.BLOCK_WIDTH * 0.2f);
			tableRightTop.add(evaporationPerDay).right().height(GameConstants.BLOCK_HEIGHT);
			tableRightTop.row();
			tableRightTop.add(alphaLabel).left().pad(GameConstants.BLOCK_WIDTH * 0.2f);
			tableRightTop.add(alpha).right().height(GameConstants.BLOCK_HEIGHT);
			tableRightTop.row();
